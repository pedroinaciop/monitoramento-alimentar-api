...
public class EmailController {
    ...
    @PostMapping("/medidas")
    public ResponseEntity<String> sendMailRelatorioMedidas(@RequestBody EmailDTO dados) throws MessagingException, IOException {
        return emailService.sendMailRelatorioMedidas(dados);
    }

    @PostMapping("/refeicoes")
    public ResponseEntity<String> sendMailRelatorioRefeicoes(@RequestBody EmailDTO dados) throws MessagingException, IOException {
